dotnet ef dbcontext scaffold "Server=REMOVED.ddns.net;Database=DataWarehouse;User Id=<user>;Password=<pw>;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer \
-o Models \
--context-dir Context \
